...
class ArticleBottomBar extends StatefulWidget {
  ...
  final double? scaleValue; // 添加缩放值参数
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      child: Transform.scale(
        scale: widget.scaleValue ?? 1.0, // 在Positioned内部应用Transform
        child: AnimatedSlide(
                  ...
                  Row(
                    ...
                    children: [
                      _buildFloatingButton(
                        ...
                        isEnabled: false,//articleController.articleUrl.isNotEmpty,
                      ),
                    ],
                  ),
