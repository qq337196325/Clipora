const Map<String, String> orderI18n = {
  ...
  'i18n_order_让阅读更智能': 'Smarter reading, more efficient learning',
  ...
  'i18n_order_足够深度阅读': 'Enough for a month of deep reading',
  'i18n_order_有效期': '@days-day Validity',
  'i18n_order_立即生效': 'Effective immediately after purchase, ample time to experience',
  ...
  'i18n_member_未来订阅计划': 'We plan to offer annual and monthly subscriptions in the future, currently offering limited-time buyout.',
  'i18n_member_现有数据保证': 'We guarantee that non-members can always use existing data for free.',
  'i18n_member_终身更新': 'Support for lifetime free updates.',
  'i18n_member_无广告保证': 'Clipora guarantees never to include advertising business, ensuring your experience. Membership is our only source of revenue.',
