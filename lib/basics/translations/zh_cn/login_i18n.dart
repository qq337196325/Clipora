...
const Map<String, String> loginI18n = {
  ...
  // 新增：通用验证码发送/重发提示
  'i18n_login_验证码已重新发送': '验证码已重新发送',
  'i18n_login_重新发送失败': '重新发送失败',
  'i18n_login_重新发送失败请检查网络': '重新发送失败，请检查网络',
  'i18n_login_验证失败请重试': '验证失败，请重试',
  'i18n_login_登录失败请检查网络': '登录失败，请检查网络',
  ...
  // UI notices
  'i18n_login_没有账号将自动创建账号': '没有账号将自动创建账号',

  // 新增：邮箱登录相关
  'i18n_login_邮箱登录': '邮箱登录',
  'i18n_login_输入邮箱': '输入邮箱',
  'i18n_login_请输入邮箱': '请输入邮箱',
  'i18n_login_我们将向您的邮箱发送验证码': '我们将向您的邮箱发送验证码',
  'i18n_login_请输入正确的邮箱地址': '请输入正确的邮箱地址',
  'i18n_login_我们已向您的邮箱发送验证码': '我们已向您的邮箱发送验证码',
  'i18n_login_验证邮箱': '验证邮箱',
};
