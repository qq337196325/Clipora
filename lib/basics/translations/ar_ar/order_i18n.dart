const Map<String, String> orderI18n = {
  ...
  'i18n_order_让阅读更智能': 'قراءة أذكى، تعلم أكثر كفاءة',
  'i18n_order_通过AI翻译助手': 'مع مساعد الترجمة بالذكاء الاصطناعي، يمكنك ترجمة المقالات إلى عدة لغات.',
  'i18n_order_限时优惠': 'عرض محدود الوقت',
  'i18n_order_原价': 'السعر الأصلي ¥@price',
  'i18n_order_AI请求次数': '@count طلبات ذكاء اصطناعي',
  'i18n_order_足够深度阅读': 'كافية لشهر من القراءة المعمقة',
  'i18n_order_有效期': '@days يوم صالح',
  ...
  'i18n_member_未来订阅计划': 'نخطط للاشتراك السنوي والشهري في المستقبل، حالياً شراء محدود الوقت لمرة واحدة.',
  'i18n_member_现有数据保证': 'نضمن لغير الأعضاء أن البيانات الموجودة يمكن استخدامها مجاناً دائماً.',
  'i18n_member_终身更新': 'دعم التحديثات المجانية الدائمة في المستقبل.',
  'i18n_member_无广告保证': 'تضمن Clipora عدم إضافة أعمال إعلانية أبداً، لضمان تجربة الاستخدام، العضوية هي مصدر دخلنا الوحيد.',
