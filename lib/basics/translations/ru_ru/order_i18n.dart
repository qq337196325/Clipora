const Map<String, String> orderI18n = {
  ...
  'i18n_order_让阅读更智能': 'Умное чтение, эффективное обучение',
  ...
  'i18n_member_未来订阅计划': 'Мы планируем предложить годовые и месячные подписки в будущем, в настоящее время ограниченная по времени единовременная покупка.',
  'i18n_member_现有数据保证': 'Мы гарантируем, что не-члены всегда могут использовать существующие данные бесплатно.',
  'i18n_member_终身更新': 'Поддержка будущих постоянных бесплатных обновлений.',
  'i18n_member_无广告保证': 'Clipora гарантирует никогда не включать рекламный бизнес, обеспечивая ваш опыт. Членство - наш единственный источник дохода.',
